...
public class XAxisRenderer extends AxisRenderer {
    ...
    protected void drawLabel(Canvas c, String formattedLabel, float x, float y, MPPointF anchor, float angleDegrees) {
        ...
        mSecondLinePaint.setColor(Color.parseColor("#CDCDCD"));
        ...
        Paint mSecondLinePaint1 = new Paint(Paint.ANTI_ALIAS_FLAG);
        mSecondLinePaint1.setColor(Color.parseColor("#CDCDCD"));
        mSecondLinePaint1.setTextAlign(Align.CENTER);
        mSecondLinePaint1.setTextSize(Utils.convertDpToPixel(10f));
        mSecondLinePaint1.setTypeface(mXAxis.getTypeface());
        ...
        if (labels.length > 1) {
            ...
            Utils.drawXAxisValue(c, labels[2], x, y + labelHeight1 + labelInterval, mSecondLinePaint1, anchor, angleDegrees);
        } else {
