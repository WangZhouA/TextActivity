...
public class VideoTutorialAdapterCopy extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public VideoTutorialAdapterCopy(Context context, List<VideoBean.DataBean.VideoInfosBean> mDatas) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        VideoTutorialAdapterCopy.MyViewHolder holder = new VideoTutorialAdapterCopy.MyViewHolder(LayoutInflater.from(
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        VideoTutorialAdapterCopy.MyViewHolder holder = (VideoTutorialAdapterCopy.MyViewHolder) viewHolder;
