...
import myapplication66.yanglh6.example.com.textactivity.entity.NewUserJiangKangBean;
 ...
 */
public class DoctorsPrescriptionActivity extends BaseActivity implements HttpRequestCallback{
...
//    TextView downFive;
   ...
   @BindView(R.id.tv_Niao)
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    tv_Xin.setText(userJiangKangBean.getData().getHeartRate()+"");
                    tv_Gan.setText(userJiangKangBean.getData().getWeight()+"");
                    tv_Xue.setText(userJiangKangBean.getData().getBloodPressureLow()+"(低压)"+"   "+userJiangKangBean.getData().getBloodPressureHeight()+"(高压)");
                    tv_Niao.setText(userJiangKangBean.getData().getUrineVolume()+"");
    ...
    protected void initView() {
        setContentView(R.layout.activity_doctors_prescription);
    }
    ...
    protected void initData() {
        ...
        setTile(getResources().getString(R.string.doctors_prescription));
        showNormeBar();
...
//        tvStrDown = new TextView[]{downOne, downTwo, downThree, downFour, downFive};
        ...
        TimeDate= TimeUtil.getCurrentTime().replaceAll("-", "/");
        daymaps.put("time", TimeDate);
        daymaps.put("userId", SPUtils.getInt(DoctorsPrescriptionActivity.this, MyConstaints.USER_ID,0)+"");
        BigModle.getInstance(DoctorsPrescriptionActivity.this).getData(DoctorsPrescriptionActivity.this, daymaps, 0x02, this, StringUtils.FIND_OUT_THE_DATE_DETAILS);


        HttpUtils.getInstance(DoctorsPrescriptionActivity.this).getSyncHttp(0x03, StringUtils.HTTP_SERVICE+StringUtils.USER_getEquDataBySameDay+ SPUtils.getInt(this, MyConstaints.USER_ID,0) ,this);
    ...
    NewUserJiangKangBean userJiangKangBean;
    ...
    public void onResponse(String sequest, int type) {
        ...
        if (type == 0x01) {
            ...
            userJiangKangBean = gson.fromJson(sequest, NewUserJiangKangBean.class);
            if (userJiangKangBean.getCode() == 1000) {
